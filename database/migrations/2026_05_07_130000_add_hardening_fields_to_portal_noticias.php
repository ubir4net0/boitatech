...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::connection($connection)->statement('ALTER TABLE portal.noticias ADD COLUMN IF NOT EXISTS image_url text');
        DB::connection($connection)->statement('ALTER TABLE portal.noticias ADD COLUMN IF NOT EXISTS normalized_title text');
        DB::connection($connection)->statement('ALTER TABLE portal.noticias ADD COLUMN IF NOT EXISTS title_signature char(64)');
        ...
        DB::connection($connection)->statement('CREATE INDEX IF NOT EXISTS portal_noticias_source_published_idx ON portal.noticias (source_key, published_at DESC)');
        DB::connection($connection)->statement('CREATE INDEX IF NOT EXISTS portal_noticias_title_signature_idx ON portal.noticias (title_signature)');
    ...
    public function down(): void
    {
        ...
        DB::connection($connection)->statement('DROP INDEX IF EXISTS portal_noticias_title_signature_idx');
        ...
        DB::connection($connection)->statement('DROP INDEX IF EXISTS portal_noticias_source_published_idx');
        ...
        DB::connection($connection)->statement('ALTER TABLE portal.noticias DROP COLUMN IF EXISTS title_signature');
        DB::connection($connection)->statement('ALTER TABLE portal.noticias DROP COLUMN IF EXISTS normalized_title');
        DB::connection($connection)->statement('ALTER TABLE portal.noticias DROP COLUMN IF EXISTS image_url');
    }
};
